...
All notable changes to `laravel-content-detect-spam` will be documented in this file.

## v1.1.0 - 2026-09-24

- Added a Laravel Boost skill (`resources/boost/skills/sharpapi-content-detect-spam/SKILL.md`) so AI agents can discover the async submit/`fetchResults()` flow, the queued-job recipe, result shape and testing approach.
...
- Initial release
- Support for detecting spam content in text with confidence scores and explanations
